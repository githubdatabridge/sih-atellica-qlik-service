...
declare module 'qix' {
    export namespace EngineAPI {
        export type CommandType =
            ...
            | 'HaveStarField';
        export type LogonType = 'LOG_ON_SERVICE_USER' | 'LOG_ON_CURRENT_USER';
        export type NxGrpType = 'N' | 'H' | 'C' | string;
        export type FieldAttributesType =
            | 'U'
            | 'A'
            | 'I'
            | 'R'
            ...
            | 'TS'
            | 'IV';
        export type FileDataFormatType =
            | 'CSV'
            | 'FIX'
            | 'DIF'
            | 'EXCEL_BIFF'
            ...
            | 'JSON'
            | 'KML';
        export type TableRecordKeyType =
            | 'NOT_KEY'
            | 'ANY_KEY'
            | 'PRIMARY_KEY'
            | 'PERFECT_KEY';
        ...
        export type ContextType =
            ...
            | 'LockedFieldsOnly'
            | 'CurrentSelections';
        export type SearchObjectsGroupType =
            | 'DatasetType'
            | 'GenericObjectsType';
        export type SearchObjectsItemType = '0' | '1';
        export type NxPatchOpType = 'Add' | 'Remove' | 'Replace';
        export type FileType = 'CSV_C' | 'CSV_T' | 'OOXML';
        export type ExportStateType = 'P' | 'A';
        export type ReductionModeType = 'N' | 'D1' | 'S' | 'C' | 'ST';
        export type FieldDefExType = '0' | '1' | '2';
        export type FolderItemType = 'FOLDER' | 'FILE' | 'OTHER';
        export type NxCellStateType =
            | 'L'
            | 'S'
            | 'O'
            | 'D'
            ...
            | 'XS'
            | 'XL';
        export type NxCellType = 'V' | 'E' | 'N' | 'T' | 'P' | 'R' | 'U';
        export type NxSelectionCellType = 'D' | 'T' | 'L';
        export type SortIndicatorType = 'N' | 'A' | 'D';
        ...
        export type OtherLimitModeType =
            | 'OTHER_GE_LIMIT'
            | 'OTHER_LE_LIMIT'
            | 'OTHER_GT_LIMIT'
            | 'OTHER_LT_LIMIT';
        export type OtherSortModeType =
            | 'OTHER_SORT_DEFAULT'
            | 'OTHER_SORT_DESCENDING'
            | 'OTHER_SORT_ASCENDING';
        export type TotalModeType = 'TOTAL_OFF' | 'TOTAL_EXPR';

        export type BnfType = 'S' | 'E';
        /**
         * One of:
         * - N for NOT_META
         * - D for META_DOC_NAME
    ...
    export  * - IT_BREAK; the engine breaks and waits for a response on what to do next.
     ...
     */
        ...
        export type ErrorDataCodeType = '0' | '1' | '2';
        ...
        export type DimensionType = 'D' | 'N' | 'T';
         ...
         */
        export type NxHypercubeMode = 'S' | 'P' | 'K' | 'T';
         ...
         */
        export type FrequencyModeType =
            | 'NX_FREQUENCY_NONE'
            | 'NX_FREQUENCY_VALUE'
            | 'NX_FREQUENCY_PERCENT'
            | 'NX_FREQUENCY_RELATIVE';

        export type TypeSortDirection = '1' | '-1' | '0';
         ...
         */
        export interface ICheckExpressionResult extends IExpressionResult {
         ...
         */
        export interface ICheckNumberOrExpressionResult
            extends IExpressionResult {
            qErrorMsg: string;
        }
         ...
         * ScriptSyntaxError...
         */
        export interface IScriptSyntaxError {
            /**
         ...
         */
        export interface INxGetBookmarkOptions {
            /**
         ...
         * NxGetObjectOptions.
         */
        export interface INxGetObjectOptions {
            /**
             * List of object types..
             */
            qTypes: string[];
         ...
         */
        export interface INxMetaTitleDescription extends INxMeta {
            /**
             * Set a title.
             */
            title: string;
         ...
         */
        export interface INxMetaTitleDescriptionTag
            extends INxMetaTitleDescription {
            /**
             * Array of String
             */
            tags: string[];
         ...
         */
        export interface INxLibraryDimensionDef {
            /**
         ...
         */
        export interface IGenericMeasureProperties extends IGenericProperties {
         ...
         */
        export interface IGenericObjectProperties extends IGenericProperties {
            qExtendsId?: string;
        }
         ...
         */
        export interface IGenericVariableProperties extends IGenericProperties {
            /**
         ...
         * DoReloadExParams...
         */
        export interface IDoReloadExParams {
            /**
             * Error handling mode
             * One of:
             *    0: for default mode
         ...
         * DoReloadExResult...
         */
        export interface IDoReloadExResult {
            /**
         ...
         * NxMatchingFieldInfo...
         */
        export interface INxMatchingFieldInfo {
            /**
             * Name of the field
             */
            qName: string;
         ...
         * NxAppProperties
         */
        export interface INxAppProperties {
            /**
             * App title.
             */
            qTitle: string;
         ...
         * AssociationScore...
         */
        export interface IAssociationScore {
            /**
             * Pair of fields.
         ...
         */
        export interface IContentLibraryListItem {
            /**
             * Name of the library.
             */
            qName: string;
         ...
         * DelimiterInfo...
         */
        export interface IDelimiterInfo {
            /**
         ...
         */
        export interface IStaticContentList {
         ...
         */
        export interface IStaticContentListItem {
            /**
         ...
         */
        export interface IStaticContentUrlDef {
            /**
             * Relative path of the thumbnail.
             */
            qUrl: string;
         ...
         * CalenderStrings...
         */
        export interface ICalenderStrings {
            /**
         ...
         * EditorBreakpoint...
         */
        export interface IEditorBreakpoint {
            /**
         ...
         */
        export interface IDerivedFieldsInTableData {
            /**
         ...
         * FieldInTableData...
         */
        export interface IFieldInTableData {
            /**
             * Name of the field.
             */
            qName: string;
         ...
         * SourceKeyRecord...
         */
        export interface ISourceKeyRecord {
            /**
         ...
         */
        export interface ITableViewTableWinSaveInfo {
            /**
             * Information about the position of the table.
             */
            qPos: IRect;
         ...
         */
        export interface ITableViewBroomPointSaveInfo {
            /**
         ...
         */
        export interface ITableViewConnectionPointSaveInfo {
            /**
         ...
         * TableViewSaveInfo...
         */
        export interface ITableViewSaveInfo {
            /**
         ...
         */
        export interface ITableViewCtlSaveInfo {
            /**
             * Internal view mode.
             */
         ...
         */
        export interface ITableViewDlgSaveInfo {
            /**
         ...
         */
        export interface ISearchCombinationOptions {
            /**
         ...
         * SearchGroupOptions...
         */
        export interface ISearchGroupOptions {
            /**
         ...
         */
        export interface ISearchGroupItemOptions {
            /**
         ...
         */
        export interface ISearchFieldDictionary {
            /**
         ...
         * SearchCharRange...
         */
        export interface ISearchCharRange {
            /**
         ...
         * SearchTermResult...
         */
        export interface ISearchTermResult {
            /**
         ...
         */
        export interface ISearchMatchCombinations {
            /**
         ...
         */
        export interface ISerachMatchCombination {
            /**
         ...
         * SerachFieldMatch...
         */
        export interface ISerachFieldMatch {
            /**
             * Position of the field in the list of fields, starting from 0.
             * The list of fields is defined in qResults/qFieldNames and contains the search associations.
             */
         ...
         */
        export interface ISearchAssociationResult {
            /**
         ...
         * SearchObjectOptions...
         */
        export interface ISearchObjectOptions {
            /**
         ...
         */
        export interface ISearchGroupItemMatch {
            /**
             * Search match value.
         ...
         */
        export interface IApp extends enigmaJS.IGeneratedAPI {
            global: IGlobal;
             ...
             */
            getLineage(): Promise<{
                qLineage: Array<{ qDiscriminator: string }>;
            }>;
            ...
            setScriptBreakpoints(
                qBreakpoints: IEditorBreakpoint[]
            ): Promise<void>;
        ...
        export interface INxFieldProperties {
         ...
         * AlternateStateData...
         */
        export interface IAlternateStateData {
            /**
         ...
         */
        export interface IBookmarkVariableItem {
            /**
             * Name of the variable.
             */
            qName: string;
         ...
         * BookmarkFieldItem...
         */
        export interface IBookmarkFieldItem {
            /**
         ...
         * GenericBaseLayout...
         */
        export interface IGenericBaseLayout {
            qInfo: INxInfo;
            qMeta: INxMeta;
        }
         ...
         */
        export interface IGenericBookmarkLayout extends IGenericBaseLayout {
         ...
         */
        export interface IGenericBookmark {
            /**
             * Applies a bookmark.
             * @returns - A promise true or false
             */
         ...
         */
        export interface IGenericBookmarkEntry {
            /**
         ...
         */
        export interface IGenericDimensionInfo {
            /**
         ...
         */
        export interface IGenericDimensionLayout extends IGenericBaseLayout {
            /*add new member */
            /**
         ...
         * NxLinkedObjectInfo...
         */
        export interface INxLinkedObjectInfo {
            /**
         ...
         * GenericObjectEntry...
         */
        export interface IGenericObjectEntry {
            /**
         ...
         * NxDataAreaPage...
         */
        export interface INxDataAreaPage {
            /**
             * Position from the left.
         ...
         * NxHighlightRanges...
         */
        export interface INxHighlightRanges {
            /**
         ...
         */
        export interface INxAttributeExpressionValues {
            /**
         ...
         * NxSimpleValue
         */
        export interface INxSimpleValue {
            /**
         ...
         */
        export interface IContinuousDataOptions {
            /**
             * Start value.
             */
            qStart: number;
         ...
         */
        export interface INxAttributeDimValues {
            /**
             * List of values.
             */
         ...
         * NxSimpleDimValue..
         */
        export interface INxSimpleDimValue {
            /**
             * Text related to the attribute expression value.
             * This property is optional. No text is returned if the attribute expression value is a numeric.
             */
         ...
         */
        export interface INxPivotDimensionCell {
            /**
             * Some text
             */
            qText: string;
         ...
         * NxStackedPivotCell...
         */
        export interface INxStackedPivotCell {
            /**
             * Some text.
             */
            qText: string;
         ...
         * GenericObjectLayout...
         */
        export interface IGenericObjectLayout extends IGenericBaseLayout {
            /*add new member */
            /**
         ...
         * NxLayoutErrors...
         */
        export interface INxLayoutErrors {
            /**
             * Error code  <Integer>
             */
            ErrorCode: number;
         ...
         * NxSelectionInfo...
         */
        export interface INxSelectionInfo {
            /**
         ...
         * RangeSelectInfo...
         */
        export interface IRangeSelectInfo {
            /* ToCheck!
         ...
         */
        export interface INxMultiRangeSelectInfo extends IRangeSelectInfo {
            /**
         ...
         */
        export interface INxRangeSelectInfo extends IRangeSelectInfo {
            /**
         ...
         */
        export interface INxContinuousRangeSelectInfo extends IRangeSelectInfo {
            /**
             * Dimension index.
             */
            qDimIx: number;
         ...
         * NxSelectionCell...
         */
        export interface INxSelectionCell {
            /**
        ...
        export interface INxTreeDataOption {
            /**
        ...
        export interface INxPageTreeNode {
            /**
        ...
        export interface INxPageTreeLevel {
            /**
         ...
         */
        export interface IGenericObject extends enigmaJS.IGeneratedAPI {
            /**
         ...
         */
        export interface IGenericMeasureLayout extends IGenericBaseLayout {
            /**
         ...
         */
        export interface IGenericVariableLayout extends IGenericBaseLayout {
            /**
             * Some text.
             */
            qText: string;
         ...
         * NxLibraryMeasureDef...
         */
        export interface INxLibraryMeasureDef {
            /**
        ...
        export interface IGenericDerivedFieldProperties
            extends IGenericProperties {}

        export interface IGenericDerivedFields extends enigmaJS.IGeneratedAPI {
            /**
             * Shows the properties of an object.
         ...
         */
        export interface IGenericMeasure extends enigmaJS.IGeneratedAPI {
            /**
             * Applies a patch to the properties of an object. Allows an update to some of the properties.
             *
             * Note: Applying a patch takes less time than resetting all the properties.
         ...
         */
        export interface IGenericVariable extends enigmaJS.IGeneratedAPI {
            /**
         ...
         * AlfaNumString...
         */
        export interface IAlfaNumString {
            /**
             * Calculated value.
             */
            qString: string;
         ...
         */
        export interface INxVariableProperties {
            /**
             * Name of the variable.
             */
            qName: string;
         ...
         */
        export interface IVariable extends enigmaJS.IGeneratedAPI {
            /**
         ...
         * IBNFDefResult
         */
        export interface IBNFDefResult {
            /**
         ...
         * CustomConnector...
         */
        export interface ICustomConnector {
            /**
            ...
            /**
             * Name of the custom connector as displayed in the Qlik export interface .
             */
            qDisplayName: string;
         ...
         * OleDbProvider...
         */
        export interface IOleDbProvider {
            /**
         ...
         */
        export interface INxStreamListEntry {
            /**
             * Name of the stream
             */
            qName: string;
        ...
        export interface IQDownloadInfo {
            /**
         ...
         */
        export interface IGlobal extends enigmaJS.IGeneratedAPI {
            /**
         ...
         * NxAttrExprInfo...
         */
        export interface INxAttrExprInfo {
            /**
             * Minimum value.
             */
            qMin: number;
         ...
         * NxStateCounts...
         */
        export interface INxStateCounts {
            /**
         ...
         * NxDimensionInfo...
         */
        export interface INxDimensionInfo {
            /**
             * Corresponds to the label of the dimension that is selected.
         ...
         * NxAttrDimInfo...
         */
        export interface INxAttrDimInfo {
            /**
         ...
         * NxValidationError...
         */
        export interface INxValidationError {
            /**
             * Error code.
         ...
         * NxMeasureInfo...
         */
        export interface INxMeasureInfo {
            /**
         ...
         */
        export interface INxInlineDimensionDef {
            /**
             * Used to define a cyclic group or drill-down group.
             * This parameter is optional.
             * Default value is no grouping.
         ...
         */
        export interface IHyperCubeDimensionqDef extends INxInlineDimensionDef {
            autoSort?: boolean;
            cId?: string;
         ...
         * OtherTotalSpecProp...
         */
        export interface IOtherTotalSpecProp {
            /**
         ...
         * NxAttrExprDef...
         */
        export interface INxAttrExprDef {
            /**
         ...
         * NxAttrDimDef...
         */
        export interface INxAttrDimDef {
            /**
         ...
         */
        export interface INxCellPosition {
            /**
         ...
         */
        export interface IStringExpressionContainer {
            /**
         ...
         * NxInlineMeasureDef...
         */
        export interface INxInlineMeasureDef {
            /**
             * Name of the measure.
             * >> This parameter is optional.
             ...
             * If using the Qlik Sense export interface , it means that the total mode is set to Expression Total.
             * >> Default is false.
             */
            qBrutalSum?: boolean;
         ...
         */
        export interface IHyperCubeMeasureqDef extends INxInlineMeasureDef {
            autoSort?: boolean;
            cId?: string;
         ...
         */
        export interface IHyperCubeMeasureDef extends INxMeasure {
         ...
         * NxPivotValuePoint...
         */
        export interface INxPivotValuePoint {
            /**
             * Label of the cell.
             * >> This parameter is optional.
             */
         ...
         * NxContainerEntry...
         */
        export interface INxContainerEntry<T> {
            /**
        ...
        //#region Prototype export interface s for Class definitions

        export interface IGenericObjectPrototype<
        ...
        export interface IAppObjectPrototype<
            P extends IGenericObjectProperties,
         ...
         */
        export interface INxListObjectExpression {
            /**
         ...
         * GenericListLayout...
         */
        export interface IGenericListLayout extends IGenericBaseLayout {
         ...
         */
        export interface INxAutoSortByStateDef {
            /**
         ...
         */
        export interface INxListObjectExpressionDef {
            /**
             * Value of the expression
             */
            qExpr: string;
         ...
         * Note: A dimension that is set in the library can be used by many objects.
         */
        export interface IListObjectDef {
            /*
             * Name of the alternate state.
             * Default is current selections $.
             */
         ...
         */
        export interface IGenericListProperties extends IGenericProperties {
        ...
        export interface IHyperCubeDimensionDef extends INxDimension {
         ...
         */
        export interface IGenericHyperCubeLayout extends IGenericObjectLayout {
         ...
         * HyperCubeDef...
         */
        export interface IHyperCubeDef {
            /**
             * Name of the alternate state.
             * Default is current selections $.
             */
         ...
         * HyperCubeDef...
         */
        export interface IVisualizationHyperCubeDef extends IHyperCubeDef {
         ...
         */
        export interface IGenericHyperCubeProperties
            extends IGenericObjectProperties {
         ...
         */
        export interface IHyperCubeObject
            extends IGenericObjectPrototype<
         ...
         */
        export interface INxCurrentSelectionItem {
            /**
         ...
         */
        export interface INxFieldSelectionInfo {
            /**
             * Name of the field.
             */
            qName: string;
         ...
         */
        export interface IGenericSelectionNxInfo extends INxInfo {
         ...
         */
        export interface IGenericSelectionListProperties
            extends IGenericObjectProperties {
         ...
         * SelectionListObject...
         */
        export interface ISelectionListObject {
            qBackCount: number;
         ...
         */
        export interface IGenericSelectionListLayout
            extends IGenericObjectLayout {
         ...
         */
        export interface IGenericBookmarkListLayout extends IGenericBaseLayout {
         ...
         */
        export interface IGenericBookmarkListNxInfo extends INxInfo {
            qType: 'BookmarkList';
        }
         ...
         */
        export interface IGenericBookmarkListProperties
            extends IGenericProperties {
         ...
         * BookmarkListDef
         */
        export interface IBookmarkListDef {
            /**
             * Type of the list
             */
            qType: 'bookmark';
         ...
         */
        export interface IBookmarkListObject
            extends IGenericObjectPrototype<
         ...
         */
        export interface IMeassureListItemLayout extends IGenericBaseLayout {
            qMeta: INxMetaTitleDescriptionTag;
            qData: null;
        }
         ...
         * IMeassureList
         */
        export interface IMeassureList {
         ...
         */
        export interface IGenericMeasureListLayout extends IGenericBaseLayout {
         ...
         */
        export interface IGenericMeassureListNxInfo extends INxInfo {
            qType: 'MeasureList';
        }
         ...
         */
        export interface IGenericMeasureListProperties
            extends IGenericProperties {
         ...
         * IMeasureListDef
         */
        export interface IMeasureListDef {
            qType: 'measure';
         ...
         * IMeassureListObject
         */
        export interface IMeassureListObject
            extends IGenericObjectPrototype<
                IGenericMeasureListProperties,
                IGenericMeasureListLayout
            > {}
         ...
         * DimensionItemLayout...
         */
        export interface IDimensionItemLayout {
            qInfo: INxInfo;
            qMeta: INxMetaTitleDescriptionTag;
            qData: null;
        }
         ...
         */
        export interface IDimensionList {
            /**
         ...
         */
        export interface IGenericDimensionListLayout
            extends IGenericBaseLayout {
         ...
         */
        export interface IGenericDimensionListNxInfo extends INxInfo {
            qType: 'DimensionList';
        }
         ...
         */
        export interface IGenericDimensionsListProperties
            extends IGenericProperties {
         ...
         */
        export interface IDimensionListDef {
            /**
             * Type of the list
             */
            qType: 'dimension';
        ...
        export interface IDimensionListObject
            extends IGenericObjectPrototype<
         ...
         * NxVariableListItem...
         */
        export interface INxVariableListItem {
            /**
             * Name of the variable.
             */
            qName: string;
         ...
         */
        export interface IGenericVariableListLayout extends IGenericBaseLayout {
         ...
         */
        export interface IGenericVariableListProperties
            extends IGenericProperties {
         ...
         */
        export interface IVariableListDef {
            /**
             * Type of the list.
             */
            qType: string;
         ...
         */
        export interface IVariableListObject
            extends IGenericObjectPrototype<
         ...
         */
        export interface IGenericFieldListProperties
            extends IGenericProperties {
            /**
             * FieldListDef...
             */
         ...
         * NxFieldDescription...
         */
        export interface INxFieldDescription {
            /**
             * If set to true, it means that the field is a semantic.
             */
            qIsSemantic: boolean;
         ...
         */
        export interface INxDerivedFieldDescriptionList {
            /**
         ...
         * NxDerivedField...
         */
        export interface INxDerivedField {
            /**
         ...
         * NxDerivedGroup...
         */
        export interface INxDerivedGroup {
            /**
         ...
         * NxDerivedFieldsData...
         */
        export interface INxDerivedFieldsData {
            /**
             * Name of the derived definition.
             */
         ...
         */
        export interface IFieldListDef {
            /**
         ...
         */
        export interface IGenericFieldLayout extends IGenericBaseLayout {
            /**
             * FieldListObject...
             */
         ...
         */
        export interface IFieldListObject
            extends IGenericObjectPrototype<
